...
export const ANNUAL_REVENUE_USD = 12_675;
...
export const websiteServices: WebsiteService[] = [
  ...
  },
  {
    ...
    priceLabel: '$150',
    description:
      'Portrait photography and photoshoots \u2014 studio or on-location. Personal branding, headshots, family, lookbooks and campaign stills, retouched and delivered ready to publish.',
    accent: '#14b8a6',
    deliverables: ['Guided portrait / photoshoot session', 'Hand-retouched final images', 'High-res + web-ready exports', 'Online gallery for download'],
    typicalScope: 'Up to a 2-hour session; studio or single location; wardrobe change friendly. Extra looks and prints quoted separately.',
    turnaround: 'Sneak-peek within 48h; full retouched gallery in 5 business days.',
  },
  {
    id: 'pro-bono',
    slug: 'community',
